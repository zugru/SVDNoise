...
from svdnoise_train_gb import q_to_z, z_to_q
...
if __name__=='__main__':
    ...
    width = 200
    # %% Load the model
    model_t0 = joblib.load('../data/bg_model_t0_thr{0}.sav'.format(int(threshold)))
    model_amplitude = joblib.load('../data/bg_model_amplitude_thr{0}.sav'.format(int(threshold)))
    # %% Make the plot
    print('Plotting maps...')
    plot_diff_map(threshold, sigma, width)
    plot_density(threshold, sigma, width, 50000)
